...
function OAuth(client, guild) { return `https://discordapp.com/oauth2/authorize?client_id=${client}&permissions=8&scope=bot&redirect_uri=https://dashboard.typicalbot.com/&response_type=code&guild_id=${guild}`; }
